...
bool constn0;
BoutReal n0_height, n0_ave, n0_width, n0_center, n0_bottom_x, Nbar, Tibar,
    Tebar;       // the total height, average width and center of profile of N0
            ...
            for (int jy = 0; jy < mesh->LocalNy; jy++)
              for (int jz = 0; jz < mesh->LocalNz; jz++) {
                ...
                BoutReal angle = rmp_m * pol_angle(jx, jy) +
                                 rmp_n * ((BoutReal)jz) * mesh->coordinates()->dz;
                rmp_Psi0(jx, jy, jz) =
