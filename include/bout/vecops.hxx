...
/// @param[in] outloc The location where the result is desired (if staggered meshes are
/// enabled)
...
/// @param[in] outloc_z  The cell location where the Z component should be defined
///
const Vector3D Grad_perp(const Field3D &f, CELL_LOC outloc_x = CELL_DEFAULT,
