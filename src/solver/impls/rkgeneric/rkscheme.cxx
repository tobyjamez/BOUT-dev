...
void RKScheme::init(const int nlocalIn, const int neqIn, const bool adaptiveIn,
                    const BoutReal atolIn, const BoutReal rtolIn, Options *options) {
...
BoutReal RKScheme::setCurTime(const BoutReal timeIn, const BoutReal dt,
                              const int curStage) {
...
void RKScheme::verifyCoeffs() {
  ...
  output << setw(10) << "TimeCoeff"
         << " | " << setw(10) << "SumStageCoeff" << endl;
  bool warn = false;
