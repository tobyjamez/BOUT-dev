...
class Mesh {
 public:
  ...
  virtual const Field3D indexDDY(const Field3D &f, CELL_LOC outloc, DIFF_METHOD method); ///< First derivative in Y direction in index space
  virtual const Field2D indexDDY(const Field2D &f); ///< ///< First derivative in Y direction in index space

  virtual const Field3D indexDDZ(const Field3D &f, CELL_LOC outloc, DIFF_METHOD method, bool inc_xbndry); ///< First derivative in Z direction in index space
  virtual const Field2D indexDDZ(const Field2D &f); ///< First derivative in Z direction in index space
  ...
  virtual const Field2D indexD2DX2(const Field2D &f); ///< Second derivative in X direction in index space
  ...
  virtual const Field2D indexD2DY2(const Field2D &f); ///< Second derivative in Y direction in index space
  ...
  virtual const Field3D indexD4DX4(const Field3D &f); ///< Fourth derivative in X direction in index space
  virtual const Field2D indexD4DX4(const Field2D &f); ///< Fourth derivative in X direction in index space
  virtual const Field3D indexD4DY4(const Field3D &f); ///< Fourth derivative in Y direction in index space
  virtual const Field2D indexD4DY4(const Field2D &f); ///< Fourth derivative in Y direction in index space
  virtual const Field3D indexD4DZ4(const Field3D &f); ///< Fourth derivative in Z direction in index space
 ...
 protected:
  ...
  virtual const Field3D applyYdiff(const Field3D &var, deriv_func func, inner_boundary_deriv_func func_in, outer_boundary_deriv_func func_out, CELL_LOC loc = CELL_DEFAULT);
