...
protected:
  ...
  /// This is set by a call to initialise, and can be used by models to specify evolving
  /// variables
  Solver *solver;
...
private:
  ...
  jacobianfunc
      userjacobian; ///< Pointer to user-supplied Jacobian-vector multiply function
