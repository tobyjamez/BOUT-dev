...
void AiolosMesh::interp_to_CtoL_Field3D_x(BoutReal* __restrict__ result_ptr,
    ...
    for (int y = 0; y < LocalNy; ++y) {
      for (int z = 0; z < LocalNz; ++z) {
        result_ptr[((x + 0) * LocalNy + y) * LocalNz + z] =
            -(1. / 16.) * in_ptr[((x - 2) * LocalNy + y) * LocalNz + z]
            + (9. / 16.) * in_ptr[((x - 1) * LocalNy + y) * LocalNz + z]
            + (9. / 16.) * in_ptr[((x + 0) * LocalNy + y) * LocalNz + z]
            - (1. / 16.) * in_ptr[((x + 1) * LocalNy + y) * LocalNz + z];
      }
    }
  }
  int x = 1;
  for (int y = 0; y < LocalNy; ++y) {
    for (int z = 0; z < LocalNz; ++z) {
      result_ptr[((x + 0) * LocalNy + y) * LocalNz + z] =
          +(5. / 16.) * in_ptr[((x - 1) * LocalNy + y) * LocalNz + z]
          + (15. / 16.) * in_ptr[((x + 0) * LocalNy + y) * LocalNz + z]
          - (5. / 16.) * in_ptr[((x + 1) * LocalNy + y) * LocalNz + z]
          + (1. / 16.) * in_ptr[((x + 2) * LocalNy + y) * LocalNz + z];
      result_ptr[((x - 1) * LocalNy + y) * LocalNz + z] =
          +(35. / 16.) * in_ptr[((x - 1) * LocalNy + y) * LocalNz + z]
          - (35. / 16.) * in_ptr[((x + 0) * LocalNy + y) * LocalNz + z]
          + (21. / 16.) * in_ptr[((x + 1) * LocalNy + y) * LocalNz + z]
          - (5. / 16.) * in_ptr[((x + 2) * LocalNy + y) * LocalNz + z];
    }
  }
  x = LocalNx - 1;
  for (int y = 0; y < LocalNy; ++y) {
    for (int z = 0; z < LocalNz; ++z) {
      result_ptr[((x + 0) * LocalNy + y) * LocalNz + z] =
          +(1. / 16.) * in_ptr[((x - 3) * LocalNy + y) * LocalNz + z]
          - (5. / 16.) * in_ptr[((x - 2) * LocalNy + y) * LocalNz + z]
          + (15. / 16.) * in_ptr[((x - 1) * LocalNy + y) * LocalNz + z]
          + (5. / 16.) * in_ptr[((x + 0) * LocalNy + y) * LocalNz + z];
    }
  }
}
void AiolosMesh::interp_to_CtoL_Field3D_y(BoutReal* __restrict__ result_ptr,
    ...
    for (int y = 2; y < LocalNy - 1; ++y) {
      for (int z = 0; z < LocalNz; ++z) {
        result_ptr[((x)*LocalNy + y + 0) * LocalNz + z] =
            -(1. / 16.) * in_ptr[((x)*LocalNy + y - 2) * LocalNz + z]
            + (9. / 16.) * in_ptr[((x)*LocalNy + y - 1) * LocalNz + z]
            + (9. / 16.) * in_ptr[((x)*LocalNy + y + 0) * LocalNz + z]
            - (1. / 16.) * in_ptr[((x)*LocalNy + y + 1) * LocalNz + z];
      }
    }
  }
  int y = 1;
  for (int x = 0; x < LocalNx; ++x) {
    for (int z = 0; z < LocalNz; ++z) {
      result_ptr[((x)*LocalNy + y + 0) * LocalNz + z] =
          +(5. / 16.) * in_ptr[((x)*LocalNy + y - 1) * LocalNz + z]
          + (15. / 16.) * in_ptr[((x)*LocalNy + y + 0) * LocalNz + z]
          - (5. / 16.) * in_ptr[((x)*LocalNy + y + 1) * LocalNz + z]
          + (1. / 16.) * in_ptr[((x)*LocalNy + y + 2) * LocalNz + z];
      result_ptr[((x)*LocalNy + y - 1) * LocalNz + z] =
          +(35. / 16.) * in_ptr[((x)*LocalNy + y - 1) * LocalNz + z]
          - (35. / 16.) * in_ptr[((x)*LocalNy + y + 0) * LocalNz + z]
          + (21. / 16.) * in_ptr[((x)*LocalNy + y + 1) * LocalNz + z]
          - (5. / 16.) * in_ptr[((x)*LocalNy + y + 2) * LocalNz + z];
    }
  }
  y = LocalNy - 1;
  for (int x = 0; x < LocalNx; ++x) {
    for (int z = 0; z < LocalNz; ++z) {
      result_ptr[((x)*LocalNy + y + 0) * LocalNz + z] =
          +(1. / 16.) * in_ptr[((x)*LocalNy + y - 3) * LocalNz + z]
          - (5. / 16.) * in_ptr[((x)*LocalNy + y - 2) * LocalNz + z]
          + (15. / 16.) * in_ptr[((x)*LocalNy + y - 1) * LocalNz + z]
          + (5. / 16.) * in_ptr[((x)*LocalNy + y + 0) * LocalNz + z];
    }
  }
}
      ...
      for (int y = 0; y < LocalNy; ++y) {
        {
          ...
          result_ptr[((x)*LocalNy + y) * LocalNz + z + 0] =
              -(1. / 16.) * in_ptr[((x)*LocalNy + y) * LocalNz + z - 2 + LocalNz]
              + (9. / 16.) * in_ptr[((x)*LocalNy + y) * LocalNz + z - 1 + LocalNz]
              + (9. / 16.) * in_ptr[((x)*LocalNy + y) * LocalNz + z + 0]
              - (1. / 16.) * in_ptr[((x)*LocalNy + y) * LocalNz + z + 1];
        }
        {
          int z = 1;
          ...
          result_ptr[((x)*LocalNy + y) * LocalNz + z + 0] =
              -(1. / 16.) * in_ptr[((x)*LocalNy + y) * LocalNz + z - 2 + LocalNz]
              + (9. / 16.) * in_ptr[((x)*LocalNy + y) * LocalNz + z - 1]
              + (9. / 16.) * in_ptr[((x)*LocalNy + y) * LocalNz + z + 0]
              - (1. / 16.) * in_ptr[((x)*LocalNy + y) * LocalNz + z + 1];
        }
        for (int z = 2; z < LocalNz - 1; ++z) {
          ...
          result_ptr[((x)*LocalNy + y) * LocalNz + z + 0] =
              -(1. / 16.) * in_ptr[((x)*LocalNy + y) * LocalNz + z - 2]
              + (9. / 16.) * in_ptr[((x)*LocalNy + y) * LocalNz + z - 1]
              + (9. / 16.) * in_ptr[((x)*LocalNy + y) * LocalNz + z + 0]
              - (1. / 16.) * in_ptr[((x)*LocalNy + y) * LocalNz + z + 1];
        }
        {
          ...
          result_ptr[((x)*LocalNy + y) * LocalNz + z + 0] =
              ...
              + (9. / 16.) * in_ptr[((x)*LocalNy + y) * LocalNz + z - 1]
              + (9. / 16.) * in_ptr[((x)*LocalNy + y) * LocalNz + z + 0]
              - (1. / 16.) * in_ptr[((x)*LocalNy + y) * LocalNz + z + 1 - LocalNz];
        }
      }
    }
  } else {
      ...
      for (int y = 0; y < LocalNy; ++y) {
        for (int z = 0; z < LocalNz; ++z) {
          ...
          result_ptr[((x)*LocalNy + y) * LocalNz + z + 0] =
              ...
              + (9. / 16.) * in_ptr[((x)*LocalNy + y) * LocalNz + +((z + 0) % LocalNz)]
              - (1. / 16.) * in_ptr[((x)*LocalNy + y) * LocalNz + +((z + 1) % LocalNz)];
        }
      }
    }
...
Field3D AiolosMesh::interp_to_do_non_uniform_x_CtoL(const Field3D& in) const {
  ...
  if (!stencil_x_CtoL.isSet) {
    ...
    BOUT_FOR(di, Region<Ind3D>(0, 1 - 1, 0, LocalNy - 1, 0, 0, LocalNy, LocalNz,
                               maxregionblocksize)) {
      // for (auto di,  Region<Ind3D>(0, 1 - 1, 0,  LocalNy - 1, 0, 0,LocalNy,LocalNz,
      // maxregionblocksize);! di.done() ; di ++) {
      auto a = 0.5 * dy[di];
    ...
    BOUT_FOR(di, Region<Ind3D>(1, 2 - 1, 0, LocalNy - 1, 0, 0, LocalNy, LocalNz,
                               maxregionblocksize)) {
      auto a = -0.5 * dy[di.xm()];
      auto b = 0.5 * dy[di];
    ...
    BOUT_FOR(di, Region<Ind3D>(LocalNx - 1, LocalNx + 0 - 1, 0, LocalNy - 1, 0, 0,
    ...
    BOUT_FOR(di, Region<Ind3D>(2, LocalNx - 1 - 1, 0, LocalNy - 1, 0, 0, LocalNy, LocalNz,
                               maxregionblocksize)) {
  ...
  BOUT_FOR(di, Region<Ind3D>(0, 2 - 1, 0, LocalNy - 1, 0, LocalNz - 1, LocalNy, LocalNz,
                             maxregionblocksize)) {
    Indices c4{di};
  ...
  BOUT_FOR(di, Region<Ind3D>(2, LocalNx - 1 - 1, 0, LocalNy - 1, 0, LocalNz - 1, LocalNy,
  ...
  BOUT_FOR(di, Region<Ind3D>(LocalNx - 2, LocalNx + 0 - 1, 0, LocalNy - 1, 0, LocalNz - 1,
                             LocalNy, LocalNz, maxregionblocksize)) {
    Indices c4{di};
    Indices c1{c4}, c2{c4}, c3{c4};
    c1.x = LocalNx - 4;
...
Field3D AiolosMesh::interp_to_do_non_uniform_x_LtoC(const Field3D& in) const {
  ...
  if (!stencil_x_LtoC.isSet) {
    ...
    BOUT_FOR(di, Region<Ind3D>(LocalNx - 2, LocalNx - 1 - 1, 0, LocalNy - 1, 0, 0,
                               LocalNy, LocalNz, maxregionblocksize)) {
      auto d = 0.5 * dy[di];
      auto c = -d;
      auto b = c - dy[di.xm()];
    ...
    BOUT_FOR(di, Region<Ind3D>(1, LocalNx - 2 - 1, 0, LocalNy - 1, 0, 0, LocalNy, LocalNz,
                               maxregionblocksize)) {
      auto c = 0.5 * dy[di];
      auto b = -c;
      auto a = b - dy[di.xm()];
  ...
  BOUT_FOR(di, Region<Ind3D>(1, LocalNx - 2 - 1, 0, LocalNy - 1, 0, LocalNz - 1, LocalNy,
                             LocalNz, maxregionblocksize)) {
...
Field3D AiolosMesh::interp_to_do_non_uniform_y_CtoL(const Field3D& in) const {
  ...
  if (!stencil_y_CtoL.isSet) {
    ...
    BOUT_FOR(di, Region<Ind3D>(0, LocalNx - 1, 0, 1 - 1, 0, 0, LocalNy, LocalNz,
                               maxregionblocksize)) {
      // for (auto di,  Region<Ind3D>(0, LocalNx - 1, 0,  1 - 1, 0, 0,LocalNy,LocalNz,
      // maxregionblocksize);! di.done() ; di ++) {
      auto a = 0.5 * dy[di];
    ...
    BOUT_FOR(di, Region<Ind3D>(0, LocalNx - 1, 1, 2 - 1, 0, 0, LocalNy, LocalNz,
                               maxregionblocksize)) {
      auto a = -0.5 * dy[di.ym()];
      auto b = 0.5 * dy[di];
    ...
    BOUT_FOR(di, Region<Ind3D>(0, LocalNx - 1, LocalNy - 1, LocalNy + 0 - 1, 0, 0,
                               LocalNy, LocalNz, maxregionblocksize)) {
    ...
    BOUT_FOR(di, Region<Ind3D>(0, LocalNx - 1, 2, LocalNy - 1 - 1, 0, 0, LocalNy, LocalNz,
                               maxregionblocksize)) {
  ...
  BOUT_FOR(di, Region<Ind3D>(0, LocalNx - 1, 0, 2 - 1, 0, LocalNz - 1, LocalNy, LocalNz,
                             maxregionblocksize)) {
    Indices c4{di};
    Indices c1{c4}, c2{c4}, c3{c4};
    c1.y = 0;
  ...
  BOUT_FOR(di, Region<Ind3D>(0, LocalNx - 1, 2, LocalNy - 1 - 1, 0, LocalNz - 1, LocalNy,
                             LocalNz, maxregionblocksize)) {
  ...
  BOUT_FOR(di, Region<Ind3D>(0, LocalNx - 1, LocalNy - 2, LocalNy + 0 - 1, 0, LocalNz - 1,
                             LocalNy, LocalNz, maxregionblocksize)) {
    Indices c4{di};
    Indices c1{c4}, c2{c4}, c3{c4};
    c1.y = LocalNy - 4;
...
Field3D AiolosMesh::interp_to_do_non_uniform_y_LtoC(const Field3D& in) const {
  ...
  if (!stencil_y_LtoC.isSet) {
    ...
    BOUT_FOR(di, Region<Ind3D>(0, LocalNx - 1, LocalNy - 2, LocalNy - 1 - 1, 0, 0,
                               LocalNy, LocalNz, maxregionblocksize)) {
      auto d = 0.5 * dy[di];
      auto c = -d;
      auto b = c - dy[di.ym()];
    ...
    BOUT_FOR(di, Region<Ind3D>(0, LocalNx - 1, 1, LocalNy - 2 - 1, 0, 0, LocalNy, LocalNz,
                               maxregionblocksize)) {
      auto c = 0.5 * dy[di];
      auto b = -c;
      auto a = b - dy[di.ym()];
  ...
  BOUT_FOR(di, Region<Ind3D>(0, LocalNx - 1, 1, LocalNy - 2 - 1, 0, LocalNz - 1, LocalNy,
                             LocalNz, maxregionblocksize)) {
  ...
  case CELL_XLOW:
    if (is_x_uniform == 2) {
      const_cast<AiolosMesh*>(this)->is_x_uniform =
          min(localmesh->getCoordinates()->dx, false, RGN_ALL)
          == max(localmesh->getCoordinates()->dx, false, RGN_ALL);
    }
    if (is_x_uniform) {
  ...
  case CELL_YLOW:
    if (is_y_uniform == 2) {
      const_cast<AiolosMesh*>(this)->is_y_uniform =
          min(localmesh->getCoordinates()->dy, false, RGN_ALL)
          == max(localmesh->getCoordinates()->dy, false, RGN_ALL);
    }
    if (is_y_uniform) {
      Field3D result(localmesh);
      result.allocate();
