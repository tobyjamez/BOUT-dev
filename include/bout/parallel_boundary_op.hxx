...
public:
  ...
  BoundaryOpPar(BoundaryRegionPar *region, std::shared_ptr<FieldGenerator> value)
      : bndry(region), gen_values(value), value_type(GEN) {}
  BoundaryOpPar(BoundaryRegionPar *region, Field3D *value)
      : bndry(region), field_values(value), value_type(FIELD) {}
  BoundaryOpPar(BoundaryRegionPar *region, BoutReal value)
      : bndry(region), real_value(value), value_type(REAL) {}
...
public:
  BoundaryOpPar_dirichlet() : BoundaryOpPar(NULL, 0.) {}
...
public:
  BoundaryOpPar_dirichlet_O3() : BoundaryOpPar(NULL, 0.) {}
...
public:
  BoundaryOpPar_dirichlet_interp() : BoundaryOpPar(NULL, 0.) {}
...
public:
  BoundaryOpPar_neumann() : BoundaryOpPar(NULL, 0.) {}
