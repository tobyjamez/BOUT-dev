...
int physics_init(bool restarting) {
  ...
  // Solving equations of the form d*Delp2(f) + 1/c*Grad_perp(c).Grad_perp(f) + a*f = b
  // for various f, a, c, d
  ...
  //   output<<"Time to set up is "<<Timer::getTime("petscsetup")<<". Time to solve is
  //   "<<Timer::getTime("petscsolve")<<endl;
