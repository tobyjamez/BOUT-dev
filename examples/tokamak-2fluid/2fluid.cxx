...
#define vE_Grad(f, p) (bracket(p, f, bm))
  ...
  int rhs(BoutReal t) override {
    ...
    default: { throw BoutException("ERROR: Invalid bkgd option\n"); }
    }
    ...
    if (evolve_te) {
      ...
      /*
        ...
        ddt(Te) -= Vpar_Grad_par(Ve, Te0) + Vpar_Grad_par(Ve0, Te) + Vpar_Grad_par(Ve,
        Te);
    ...
    if (evolve_ti) {
      ...
      /*
        ...
        ddt(Ti) -= Vpar_Grad_par(Vi, Ti0) + Vpar_Grad_par(Vi0, Ti) + Vpar_Grad_par(Vi,
        Ti);
    ...
    default: { throw BoutException("ERROR: invalid option for iTe_dc\n"); }
    }
