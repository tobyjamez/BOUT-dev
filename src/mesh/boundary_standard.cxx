...
void verifyNumPoints(BoundaryRegion *region, int ptsRequired) {
  ...
  default: {
    throw BoutException("Unrecognised boundary region (%s) for verifyNumPoints.",
                        region->location);
  }
#endif
  }
      ...
      if (bndry->by != 0) {
        ...
        for (; !bndry->isDone(); bndry->next1d()) {
          if (fg) {
            ...
            BoutReal xnorm =
                0.5 * (mesh->GlobalX(bndry->x) + mesh->GlobalX(bndry->x - 1));
            BoutReal ynorm =
        ...
        for (; !bndry->isDone(); bndry->next1d()) {
          ...
          if (fg) {
            ...
            BoutReal xnorm =
                0.5 * (mesh->GlobalX(bndry->x) + mesh->GlobalX(bndry->x - bndry->bx));
            BoutReal ynorm =
                0.5 * (mesh->GlobalY(bndry->y) + mesh->GlobalY(bndry->y - 1));
            val = fg->generate(xnorm, TWOPI * ynorm, 0.0, t);
          }
          f(bndry->x, bndry->y) = 2 * val - f(bndry->x - bndry->bx, bndry->y - bndry->by);
...
void BoundaryDirichlet_O3::apply(Field2D &f, BoutReal t) {
  ...
  if (mesh->StaggerGrids && loc != CELL_CENTRE) {
    ...
    for (; !bndry->isDone(); bndry->next1d()) {
      ...
      f(bndry->x, bndry->y) = (8. / 3) * val -
                              2. * f(bndry->x - bndry->bx, bndry->y - bndry->by) +
                              f(bndry->x - 2 * bndry->bx, bndry->y - 2 * bndry->by) / 3.;
...
BoundaryOp *BoundaryDirichlet_2ndOrder::clone(BoundaryRegion *region,
                                              const list<string> &args) {
...
void BoundaryDirichlet_2ndOrder::apply(Field2D &f) {
  ...
  for (bndry->first(); !bndry->isDone(); bndry->next1d()) {
    f(bndry->x, bndry->y) =
        8. / 3. * val - 2. * f(bndry->x - bndry->bx, bndry->y - bndry->by) +
        1. / 3. * f(bndry->x - 2 * bndry->bx, bndry->y - 2 * bndry->by);
#ifdef BOUNDARY_CONDITIONS_UPGRADE_EXTRAPOLATE_FOR_2ND_ORDER
    f(bndry->x + bndry->bx, bndry->y + bndry->by) =
        3. * f(bndry->x, bndry->y) - 3. * f(bndry->x - bndry->bx, bndry->y - bndry->by) +
        f(bndry->x - 2 * bndry->bx, bndry->y - 2 * bndry->by);
#elif defined(CHECK)
...
void BoundaryDirichlet_2ndOrder::apply(Field3D &f) {
  ...
  for (bndry->first(); !bndry->isDone(); bndry->next1d())
    for (int z = 0; z < mesh->LocalNz; z++) {
      f(bndry->x, bndry->y, z) =
          8. / 3. * val - 2. * f(bndry->x - bndry->bx, bndry->y - bndry->by, z) +
          1. / 3. * f(bndry->x - 2 * bndry->bx, bndry->y - 2 * bndry->by, z);
#ifdef BOUNDARY_CONDITIONS_UPGRADE_EXTRAPOLATE_FOR_2ND_ORDER
      f(bndry->x + bndry->bx, bndry->y + bndry->by, z) =
          3. * f(bndry->x, bndry->y, z) -
          3. * f(bndry->x - bndry->bx, bndry->y - bndry->by, z) +
...
void BoundaryNeumann_NonOrthogonal::apply(Field2D &f) {
  ...
  for (bndry->first(); !bndry->isDone(); bndry->next1d()) {
    ...
    BoutReal g11shift = 0.5 * (metric->g11(bndry->x, bndry->y) +
                               metric->g11(bndry->x - bndry->bx, bndry->y));
    BoutReal g12shift = 0.5 * (metric->g12(bndry->x, bndry->y) +
...
void BoundaryNeumann_NonOrthogonal::apply(Field3D &f) {
  ...
  for (bndry->first(); !bndry->isDone(); bndry->next1d()) {
    ...
    BoutReal g12shift = 0.5 * (metric->g12(bndry->x, bndry->y) +
                               metric->g12(bndry->x - bndry->bx, bndry->y));
    BoutReal g13shift = 0.5 * (metric->g13(bndry->x, bndry->y) +
                               metric->g13(bndry->x - bndry->bx, bndry->y));
    // Have to use derivatives at last gridpoint instead of derivatives on boundary layer
    //   because derivative values don't exist in boundary region
    // NOTE: should be fixed to interpolate to boundary line
    for (int z = 0; z < mesh->LocalNz; z++) {
...
void BoundaryNeumann2::apply(Field2D &f) {
  ...
  for (bndry->first(); !bndry->isDone(); bndry->next())
    f(bndry->x, bndry->y) = (4. * f(bndry->x - bndry->bx, bndry->y - bndry->by) -
                             f(bndry->x - 2 * bndry->bx, bndry->y - 2 * bndry->by)) /
                            3.;
}
...
void BoundaryNeumann2::apply(Field3D &f) {
  for (bndry->first(); !bndry->isDone(); bndry->next())
    for (int z = 0; z < mesh->LocalNz; z++)
      f(bndry->x, bndry->y, z) =
          (4. * f(bndry->x - bndry->bx, bndry->y - bndry->by, z) -
           f(bndry->x - 2 * bndry->bx, bndry->y - 2 * bndry->by, z)) /
          3.;
}
...
BoundaryOp *BoundaryNeumann_2ndOrder::clone(BoundaryRegion *region,
                                            const list<string> &args) {
...
void BoundaryNeumann_2ndOrder::apply(Field2D &f) {
  ...
  // Set (at 2nd order) the gradient at the mid-point between the guard cell and the grid
  // cell to be val
  // This sets the value of the co-ordinate derivative, i.e. DDX/DDY not
  // Grad_par/Grad_perp.x
  // N.B. Only first guard cells (closest to the grid) should ever be used
  for (bndry->first(); !bndry->isDone(); bndry->next1d()) {
    f(bndry->x, bndry->y) = f(bndry->x - bndry->bx, bndry->y - bndry->by) +
                            val * (bndry->bx * metric->dx(bndry->x, bndry->y) +
  ...
  for (bndry->first(); !bndry->isDone(); bndry->next1d())
    for (int z = 0; z < mesh->LocalNz; z++) {
      BoutReal delta = bndry->bx * metric->dx(bndry->x, bndry->y) +
                       bndry->by * metric->dy(bndry->x, bndry->y);
      f(bndry->x, bndry->y, z) =
          f(bndry->x - bndry->bx, bndry->y - bndry->by, z) + val * delta;
#ifdef BOUNDARY_CONDITIONS_UPGRADE_EXTRAPOLATE_FOR_2ND_ORDER
      f(bndry->x + bndry->bx, bndry->y + bndry->by, z) =
          3. * f(bndry->x, bndry->y, z) -
          3. * f(bndry->x - bndry->bx, bndry->y - bndry->by, z) +
      ...
      if (bndry->bx > 0) {
        ...
        for (; !bndry->isDone(); bndry->next1d()) {
          ...
          for (int i = 1; i < bndry->width; i++) {
            ...
            // and these points
            // may be used be used by 2nd order upwinding type schemes, which require 3rd
            // order
            f(xi, yi) = 3.0 * f(xi - bndry->bx, yi - bndry->by) -
                        3.0 * f(xi - 2 * bndry->bx, yi - 2 * bndry->by) +
                        f(xi - 3 * bndry->bx, yi - 3 * bndry->by);
      ...
      if (bndry->by < 0) {
        ...
        for (; !bndry->isDone(); bndry->next1d()) {
          ...
          if (fg) {
            ...
            val = fg->generate(xnorm, TWOPI * ynorm, 0.0, t) *
                  metric->dx(bndry->x, bndry->y - bndry->by);
          }
          f(bndry->x, bndry->y - bndry->by) =
        ...
        for (; !bndry->isDone(); bndry->next1d()) {
          ...
          for (int zk = 0; zk < mesh->LocalNz; zk++) {
            ...
            for (int i = 1; i < bndry->width; i++) {
              ...
              // order, and these points
              // may be used be used by 2nd order upwinding type schemes, which require
              // 3rd order
              f(xi, yi, zk) = 3.0 * f(xi - bndry->bx, yi - bndry->by, zk) -
                              3.0 * f(xi - 2 * bndry->bx, yi - 2 * bndry->by, zk) +
                              f(xi - 3 * bndry->bx, yi - 3 * bndry->by, zk);
      ...
      if (bndry->bx < 0) {
        ...
        for (; !bndry->isDone(); bndry->next1d()) {
          ...
          for (int zk = 0; zk < mesh->LocalNz; zk++) {
            ...
            if (fg)
              val = fg->generate(xnorm, TWOPI * ynorm, TWOPI * zk / (mesh->LocalNz), t) *
                    metric->dx(bndry->x - bndry->bx, bndry->y);
  ...
  for (bndry->first(); !bndry->isDone(); bndry->next1d()) {
    ...
    f(bndry->x + bndry->bx, bndry->y + bndry->by) =
        ...
        f(bndry->x - 2 * bndry->bx,
          bndry->y - 2 * bndry->by); // The f(bndry->x-4*bndry->bx,bndry->y-4*bndry->by)
                                     // term vanishes, so that this sets to zero the 4th
                                     // order central difference first derivative at the
                                     // point half way between the guard cell and the grid
                                     // cell
  }
}
...
void BoundaryConstGradient::apply(Field3D &f) {
  for (bndry->first(); !bndry->isDone(); bndry->next())
    for (int z = 0; z < mesh->LocalNz; z++)
      f(bndry->x, bndry->y, z) = 2. * f(bndry->x - bndry->bx, bndry->y - bndry->by, z) -
                                 f(bndry->x - 2 * bndry->bx, bndry->y - 2 * bndry->by, z);
}
